        ...
        <div class="max-w mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-end py-2">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('login') }}" class="text-sm hover-gold transition-smooth">Masuk</a>
                    <a href="{{ route('register') }}" class="text-sm gold-gradient text-gray-900 px-3 py-1 rounded-lg font-medium hover:shadow-lg transition-smooth">Daftar</a>
                </div>
            </div>
