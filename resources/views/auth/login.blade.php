...
<section class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 py-12">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-gray-900 to-black py-6 px-8 text-center">
            ...
            <h2 class="text-2xl font-bold text-white mb-1">Masuk ke Akun</h2>
            <p class="text-gray-300 text-sm">Selamat datang kembali di Luxury Allure</p>
        </div>
        ...
        <div class="p-8">
            <form action="{{ route('login') }}" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-sm text-yellow-600 hover:text-yellow-700 font-medium transition-colors duration-200">
                        Lupa password?
                    </a>
                </div>
            ...
            <div class="mt-6 pt-6 border-t border-gray-200 text-center">
                <p class="text-sm text-gray-600">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="text-yellow-600 hover:text-yellow-700 font-semibold transition-colors duration-200">
                        Daftar sekarang
                    </a>
                </p>
            </div>
